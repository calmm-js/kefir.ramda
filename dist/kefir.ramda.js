(function (global, factory) {
  ...
  var composeK = /*#__PURE__*/K.liftRec(function composeK() {
    if (!composeK.warned) {
      composeK.warned = 1;
  ...
  var composeP = /*#__PURE__*/K.liftRec(function composeP() {
    if (!composeP.warned) {
      composeP.warned = 1;
  ...
  var contains = /*#__PURE__*/K.lift(function contains(_0, _1) {
    if (!contains.warned) {
      contains.warned = 1;
  ...
  var merge = /*#__PURE__*/K.lift(function merge(_0, _1) {
    if (!merge.warned) {
      merge.warned = 1;
  ...
  var pipeK = /*#__PURE__*/K.liftRec(function pipeK() {
    if (!pipeK.warned) {
      pipeK.warned = 1;
  ...
  var pipeP = /*#__PURE__*/K.liftRec(function pipeP() {
    if (!pipeP.warned) {
      pipeP.warned = 1;
